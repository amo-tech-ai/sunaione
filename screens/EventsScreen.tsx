    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col group transition-all hover:shadow-lg hover:-translate-y-1">
        ...
        <div className="p-6 flex flex-col flex-grow">
            <div className="flex justify-between items-start">
                <span className="text-xs font-bold px-2 py-1 rounded-full self-start bg-orange-100 text-amo-orange">{event.category}</span>
            ...
            <h3 className="font-bold text-lg text-amo-dark mt-3 flex-grow">{event.title}</h3>
                ...
                >
                 ...
                 <button 
                    ...
                    className={`flex-1 font-semibold py-2 rounded-lg transition-colors text-sm text-white ${
                        event.registered ? 'bg-gray-500 hover:bg-gray-600' : 'bg-amo-orange hover:bg-opacity-90'
                    }`}
