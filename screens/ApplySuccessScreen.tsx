        ...
        <div className="bg-amo-beige font-sans min-h-screen flex flex-col">
            ...
            <main className="flex-grow flex items-center justify-center p-4 relative overflow-hidden">
                ...
                <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl border border-gray-200 p-8 md:p-12 text-center">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-amo-dark mt-6">Application Submitted!</h1>
                    ...
                    <div className="text-left mt-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                        <h2 className="text-xl font-bold text-amo-dark mb-4">What happens next?</h2>
                        <ul className="space-y-4">
                            <li className="flex items-start gap-4">
                                <div className="flex-shrink-0 w-8 h-8 bg-amo-orange/10 text-amo-orange font-bold text-lg rounded-full flex items-center justify-center">1</div>
                                <div>
                            ...
                            <li className="flex items-start gap-4">
                                <div className="flex-shrink-0 w-8 h-8 bg-amo-orange/10 text-amo-orange font-bold text-lg rounded-full flex items-center justify-center">2</div>
                                <div>
                             ...
                             <li className="flex items-start gap-4">
                                <div className="flex-shrink-0 w-8 h-8 bg-amo-orange/10 text-amo-orange font-bold text-lg rounded-full flex items-center justify-center">3</div>
                                <div>
